...
CAPI void alt_DiscordOAuth2Token_CAPI_Free(struct alt_DiscordOAuth2Token* ptr);

CAPI void alt_DiscordOAuth2Token_Create(struct alt_DiscordOAuth2Token* _p0, struct alt_DiscordOAuth2Token* _returnValue);

// Return ptr must be manually freed with alt_DiscordOAuth2Token_CAPI_Free()
CAPI struct alt_DiscordOAuth2Token* alt_DiscordOAuth2Token_Create_CAPI_Heap(struct alt_DiscordOAuth2Token* _p0);

CAPI void alt_DiscordOAuth2Token_Create_1(struct alt_DiscordOAuth2Token* _p0, struct alt_DiscordOAuth2Token* _returnValue);

// Return ptr must be manually freed with alt_DiscordOAuth2Token_CAPI_Free()
CAPI struct alt_DiscordOAuth2Token* alt_DiscordOAuth2Token_Create_1_CAPI_Heap(struct alt_DiscordOAuth2Token* _p0);
